            ...
            .map((post, index) => (
              ...
              >
                ...
                <div className="relative overflow-hidden h-64">
                  ...
                  {/* Content Overlay */}
                  <div className="absolute top-0 left-0 right-0 bottom-0 p-6 flex flex-col justify-end text-white">
                    <div className="mb-2">
                      <span className="inline-flex items-center px-2 py-1 bg-white/20 backdrop-blur-sm text-white rounded-full text-xs font-medium border border-white/30">
                        {post.category}
                      </span>
                    </div>
                  ...
                  <div className="absolute top-3 right-3 z-10">
                    <span className={`px-2 py-1 rounded-full text-xs font-medium shadow-sm ${post.type === 'video'
                ...
                <div className="p-6">
                  ...
                  <Link
                    to={`/blog/${post.id}`}
                    className="text-blue-600 hover:text-blue-700 font-medium text-sm group inline-flex items-center space-x-1"
                  >
